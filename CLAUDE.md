...
This project is indexed by GitNexus as **ADAM** (539 symbols, 735 relationships, 11 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
