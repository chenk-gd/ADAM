...
This project is indexed by GitNexus as **ADAM** (2782 symbols, 6649 relationships, 243 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
